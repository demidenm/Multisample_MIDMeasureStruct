...
colnames(ahrb_efa$loadings) <- paste("AB", 1:ahrb_efa$factors)
...
colnames(factor_corr_ahrb) = paste(c("1","2","3","4","5","6"))
rownames(factor_corr_ahrb) = paste(c("AB 1","AB 2","AB 3","AB 4","AB 5","AB 6"))
factor_corr_ahrb
...
ahrb_efa_loadings_rev <- ahrb_efa$loadings#[,c(2,1,4,3,6,5)]
...
colnames(factor_corr_mls) = paste(c("1","2","3","4","5","6","7"))
rownames(factor_corr_mls) = paste(c("MS 1","MS 2","MS 3","MS 4","MS 5","MS 6","MS 7"))
factor_corr_mls
...
(for html report only providing 100 to reduce run time)
...
corrplot(cor(abcd_r1), method = "color", tl.pos = "ld", number.digits = 2,addCoef.col = "black",number.cex = .4,
         tl.cex = .6, tl.col = "black", type = "lower",
         title = "ABCD Run 1", mar = c(0,0,1,0))

corrplot(cor(abcd_r2), method = "color", tl.pos = "ld", number.digits = 2, addCoef.col = "black",number.cex = .4,
         tl.cex = .8, tl.col = "black", type = "lower", title = "ABCD Run 2", mar = c(0,0,1,0))
```
...
label_nacc = c("AWin_v_Neut_L_NAc_r1","BWin_v_Neut_L_NAc_r1","AWin_v_Neut_L_NAc_r2","BWin_v_Neut_L_NAc_r2",
               "AWin_v_Neut_R_NAc_r1","BWin_v_Neut_R_NAc_r1","AWin_v_Neut_R_NAc_r2","BWin_v_Neut_R_NAc_r2")
               
label_ins = c("AWin_v_Neut_L_Ins_r1","BWin_v_Neut_L_Ins_r1","AWin_v_Neut_L_Ins_r2","BWin_v_Neut_L_Ins_r2",
              "AWin_v_Neut_R_Ins_r1","BWin_v_Neut_R_Ins_r1","AWin_v_Neut_R_Ins_r2","BWin_v_Neut_R_Ins_r2")
...
corrplot(cor(ahrb_r1), method = "color", tl.pos = "ld", number.digits = 2, addCoef.col = "black",number.cex = .4,
         tl.cex = .8, tl.col = "black", type = "lower", title = "AHRB Run 1", mar = c(0,0,1,0))
corrplot(cor(ahrb_r2), method = "color", tl.pos = "ld", number.digits = 2, addCoef.col = "black",number.cex = .4,
         tl.cex = .8, tl.col = "black", type = "lower", title = "AHRB Run 1", mar = c(0,0,1,0))
```
```{r fig.height=14, fig.width=12, message=FALSE, warning=FALSE}
...
corrplot(cor(mls_r1), method = "color", tl.pos = "ld", number.digits = 2, addCoef.col = "black",number.cex = .4,
         tl.cex = .8, tl.col = "black", type = "lower", title = "MLS Run 1", mar = c(0,0,1,0))
corrplot(cor(mls_r2), method = "color", tl.pos = "ld", number.digits = 2, addCoef.col = "black",number.cex = .4,
         tl.cex = .8, tl.col = "black", type = "lower", title = "MLS Run 1", mar = c(0,0,1,0))
```
