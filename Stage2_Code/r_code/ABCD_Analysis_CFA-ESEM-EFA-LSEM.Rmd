...
colnames(factor_corr_abcd) = paste("AD",1:abcd_efa$factors)
...
colnames(factor_corr_ahrb) = paste("AB",1:ahrb_efa$factors)
...
colnames(factor_corr_mls) = paste("AB",1:mls_efa$factors)
rownames(factor_corr_mls) = paste("AB",1:mls_efa$factors)
factor_corr_mls
```
...
ahrb_revised <- c("AB2","AB1","AB4","AB3","AB6","AB5")
