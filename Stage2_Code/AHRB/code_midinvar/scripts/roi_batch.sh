...
roi_scratch="/scratch/../AHRB/analyses/proj_midinvar/ROI_est"
...
python ./python_scripts/betamap_roi.py ${data_preproc} ${roi_dir} ${first_in} ${roi_scratch}
